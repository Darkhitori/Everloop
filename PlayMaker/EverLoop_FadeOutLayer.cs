...
namespace HutongGames.PlayMaker.Actions
{
	...
	[Tooltip("Linearly fade out a specific layer. ")]
	public class EverLoop_FadeOutLayer : FsmStateAction
	{
		[RequiredField]
		...
		void DoTheMagic()
		{
			...
			theScript.FadeOutLayer(fLayer, duration.Value, ignoreTimeScale.Value);
